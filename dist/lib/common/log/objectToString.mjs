...
function objectToString(object, { maxLevel = 15, maxValueSize = 5000, maxFuncSize = 100, maxProperties = 50, maxListSize = 10, maxResultSize = 50000, filter = filterDefault, } = {}) {
    if (object == null) {
        return object + '';
    }
    const buffer = [];
    ...
    function appendBuffer(value, maxSize) {
    ...
    const append = (obj, tabs, level = 0) => {
        ...
        if (obj instanceof Error) {
            obj = Object.assign({ constructor: obj.constructor, message: obj.message, stack: obj.stack || obj.toString() }, obj);
        }
...
export { filterDefault, objectToString };
