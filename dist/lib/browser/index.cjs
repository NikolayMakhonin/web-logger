...
var browser_log_LoggerBrowser = require('./log/LoggerBrowser.cjs');
var browser_log_SendToRemoteHandler = require('./log/SendToRemoteHandler.cjs');
var browser_log_SendLogHandlerBrowser = require('./log/SendLogHandlerBrowser.cjs');
...
exports.LoggerBrowser = browser_log_LoggerBrowser.LoggerBrowser;
exports.logger = browser_log_LoggerBrowser.logger;
exports.SendToRemoteHandler = browser_log_SendToRemoteHandler.SendToRemoteHandler;
exports.SendLogHandlerBrowser = browser_log_SendLogHandlerBrowser.SendLogHandlerBrowser;
