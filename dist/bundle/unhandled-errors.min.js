...
if(t(e.target),t(e.currentTarget),t(e.srcElement),t(e.path),"function"==typeof e.composedPath)try{
...
;if(null==e)return e+""
;var b=[],w=0,j=new String("Overflow")
;function _(e,n){var r=Math.min(e.length,c,h-w)
;if(null!=n&&r>n&&(r=n),e.length>r&&(e=e.substring(0,r)+"..."),
b.push(e),(w+=e.length)>=h)throw b.push("..."),
w+=3,j}var L=new Set,O=function(e,r,t){
...
if(e.valueOf){var o=e.valueOf();if(o!==e){
if(e.constructor)_("<"),_(e.constructor.name),
(u=S(e))&&(_("-"),_(u.toString())),_("> ")
;return void O(o,r,t)}}
if(t>=i)return void _("...")
;if(t++,!E(e))return _("<"),_(e.constructor.name),void _("> {...}")
;var a=s,c=d
;if(L.has(e)?(a=0,c=0):L.add(e),Array.isArray(e))_("["),a=c;else if(e.constructor){
var u
;_("<"),_(e.constructor.name),(u=S(e))&&(_("-"),_(u.toString())),_("> {")
}else _("{");var f=r+"\t",v=0
;if("function"==typeof Event&&e instanceof Event){
var p=m(e)
;_(0===v?"\r\n":",\r\n"),_(f),_("_errors"),_(": "),O(p,f,t),v++
}
if(v>=a)_("..."),v>0&&_("\r\n");else for(var h in e){
if(_(0===v?"\r\n":",\r\n"),v>=a){_(f),_("...\r\n")
;break}
_(f),_(""===h?'""':h),_(": "),O(e[h],f,t),v++}
if(v>0&&(_(",\r\n"),_(r)),Array.isArray(e)?_("]"):_("}"),
!Array.isArray(e)&&Symbol.iterator in e){
if(_("["),(v=0)>=c)_("...");else try{
for(var y=e[Symbol.iterator],g=void 0;!(g=y()).done;){
var b=g.value
;if(_(v>0?",\r\n":"\r\n"),_(r),_(v.toString()),_(": "),O(b,f,t),++v>=c){
_(f),_("...");break}}}catch(e){
_("<iterate error>: "+e.message)}
v>0&&(_(",\r\n"),_(r)),_("]")}}
}else _(e.toString());else _("null");else _("undefined")
};try{O(e,"",null)}catch(e){if(e!==j)throw e}
return b.join("")}
...
var n=void 0===e?{}:e,i=n.catchUnhandled,a=void 0===i||i,c=n.catchEval,u=void 0===c||c,l=n.catchConsoleLevels,s=void 0===l?["error"]:l,p=n.filterEval,h=void 0===p?null:p,g=n.alert,m=void 0!==g&&g,E=n.maxLogLength,b=void 0===E?2048:E,S=n.customLog,j=[]
;function _(){
for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n]
;var r=e.map((function(e){return w(e)
})).join("\n")
;b&&r.length>b&&(r=r.substring(0,b-3)+"..."),S&&S(r)||(m&&o.alert&&o.alert(r),
